            ...
            <div class=" col-lg-8  col-md-6 col-sm-6 col-xs-12 mgnT15">
              ...
              <div class="mangeactionwrp">
                <ul class="mangeactnbtnul">
                  <li class="mangeactbtnli left">
                    ...
                    <div class="mangeactnlistwrp mangeactnlistwrp1">
                      <ul class="mangeactionul">
                        ...
                        <li class="mangeactionli"><a style="cursor:pointer;" id="unfeatured_8" class="mangeaction_a markunfeatured"><i class="fa fa-angle-double-right"></i>Remove Featured Status</a></li>
                  ...
                  <li class="mangeactbtnli left">
                    <a class="mangactnbtn lblue_bg pdg10">Manage Agents <i class="fa fa-angle-down"></i></a>
                    <div class="mangeactnlistwrp mangeactnlistwrp2">
                      <ul class="mangeactionul">
                        <li class="mangeactionli"><a href="#" class="mangeaction_a"><i class="fa fa-angle-double-right"></i>Manage Associated Agents</a></li>
                        <li class="mangeactionli"><a href="#" class="mangeaction_a"><i class="fa fa-angle-double-right"></i>Associate Agents To Listing</a></li>
                      </ul>
                    </div>
                  </li>
