    ...
    <div class="inner">
      <div class="mainindexcontainer">
        ...
        <div class="seinwrp fulwidthm left">
          ...
          <div id="errordisp" style="visibility:hidden;"><b><i class="fa fa-arrow-circle-up"></i> Please Set a Location</b></div>
        </div>
      </div>
    </div>
  </div>
...
<div class="indexcwrper fulwidthm left mgnB20 ">
  ...
  <p class="listsub robotolight fontsize16">In the last 24 Hours</p>
              ...
              <div class="ststusbox text-center col-lg-3 col-sm-6 col-xs-12 mgnB10">
                <div class="ststusbox_in">
                  ...
                  <div class="status_dindex graybg">
                    ...
                    <p class="stsusname fontsize18 robotolight">Open Houses</p>
                  </div>
                </div>
              </div>
              <div class="ststusbox text-center col-lg-3 col-sm-6 col-xs-12 mgnB10">
                <div class="ststusbox_in">
                  ...
                  <div class="status_dindex graybg">
                    ...
                    <p class="stsusname fontsize18 robotolight">Sold Listings</p>
                  </div>
                </div>
              </div>
              <div class="ststusbox text-center col-lg-3 col-sm-6 col-xs-12 mgnB10">
                <div class="ststusbox_in">
                  ...
                  <div class="status_dindex graybg">
                    ...
                    <p class="stsusname fontsize18 robotolight">Price Reduced</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section class="indexbox  mgnTB15 whitebg fulwidthm left">
        <div class="indexbox_in pdg20 fulwidthm left">
          <div class="listingstutstilte text-center">
            <h4 class="robotolight fontsize24">Top Cities in <span class=" robotomedium">United States</span></h4>
            <p class="listsub robotolight fontsize16">Find Places to Buy/Rent in these Cities</p>
          </div>
          <div class="populrcitwrp fulwidthm mgnT30 left">
            <div class="row">
                ...
                <div class="indexbox_in pdg20 fulwidthm left">
                  <div class="indexcaluclatorwrp">
                    <div class="ca_tb_btnwrp">
                      <div class="cal_tab_btn active"> Home Affordability Calculator</div>
                      <div class="cal_tab_btn"> Mortgage Calculator</div>
                      <div class="cal_tab_btn"> Rent Vs Buy Calculator</div>
                    </div>
                          ...
                          <div class="row mgnT60">
                            <div class="calculatorleft col-sm-4 col-xs-12">
                              <div class="calrow fulwidthm left mgnB20">
                                <label class="callabel robotoregular fontsize18 mgnB10 graytext">Monthly Payment (₪)</label>
                              ...
                              <div class="calrow fulwidthm left mgnB20">
                                <label class="callabel robotoregular fontsize18 mgnB10 graytext"> Down Payment (₪)</label>
                              ...
                              <div class="calrow fulwidthm left mgnB20">
                                <label class="callabel robotoregular fontsize18 mgnB10 graytext"> Rate of Interest (%)</label>
                              ...
                              <div class="calrow fulwidthm left mgnB20">
                                <label class="callabel robotoregular fontsize18 mgnB10 graytext">No of Years</label>
                      ...
                      <div class="cal_tabbox ">
                        <div class="cal_tabbox_in pdgTB30">
                          ...
                          <div class="row mgnT60">
                            <div class="calculatorleft col-sm-4 col-xs-12">
                              <div class="calrow fulwidthm left mgnB20">
                                <label class="callabel robotoregular fontsize18 mgnB10 graytext"> Mortgage Amount (₪)</label>
                      ...
                      <div class="cal_tabbox ">
                        <div class="cal_tabbox_in pdgTB30">
                          ...
                          <div class="row mgnT60">
                            <div class="calculatorleft col-sm-4 col-xs-12">
                              <div class="calrow fulwidthm left mgnB20">
                                <label class="callabel robotoregular fontsize18 mgnB10 graytext"> Desired Home Price (₪)</label>
                                <input id="desiredhomeprice" class="gcinput fulwidthm left" type="text" value="800000">
                                <div class=" rederror fulwidthm left" id="e1"></div>
                              </div>
                              <div class="calrow fulwidthm left mgnB20">
                                <label class="callabel robotoregular fontsize18 mgnB10 graytext"> Desired Monthly Rent (₪)</label>
              ...
              <section class="indexbox  mgnTB15 whitebg fulwidthm left">
                <div class="indexbox_in pdg20 fulwidthm left">
                  <div class="listingstutstilte text-center">
                    <h4 class="robotolight fontsize24">Why <span class=" robotomedium">For Sale Network ?</span></h4>
                    ...
                    <div class="whyuswrp fulwidthm left mgnT30">
                      <div class="whyusbox col-sm-4 col-xs-12 mgnB10">
                        <div class="whyusboxin listforubox">
                          <h4 class="robotomedium graytext fontsize18">Homes for You</h4>
                          <p class="robotoregular font-size14 lgraytext">you can find a wide variety of homes in For Sale Network </p> <a href="#" class=" robotomedium lbluetext">Know More >> </a></div>
                      </div>
                      <div class="whyusbox col-sm-4 col-xs-12 mgnB10">
                        <div class="whyusboxin hwselbox">
                          <h4 class="robotomedium graytext fontsize18">Want To Sell</h4>
                          <p class="robotoregular font-size14 lgraytext">For Sale Network helps you to sell your home in record time </p> <a href="#" class=" robotomedium lbluetext">Know More >> </a></div>
                      </div>
                      <div class="whyusbox col-sm-4 col-xs-12 mgnB10">
                        <div class="whyusboxin hwwrk">
                          <h4 class="robotomedium graytext fontsize18">How It Works</h4>
                          <p class="robotoregular font-size14 lgraytext">Find out how to Buy/Sell/Rent a home on For Sale Network </p> <a href="#" class=" robotomedium lbluetext">Know More >> </a></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="mainontainer_in pdgS10">
                <div class="footerbox pdgTB50 fulwidthm left">
                  ...
                  <div class="footerboxeach col-lg-4 col-md-4 col-sm-4 col-xs-4">
                    ...
                    <div class="clearfix"></div>
                    <ul class="footerul robotomedium">
                      <li class="footerli"><a class="footera graytext" href="#">Homes for Sale in Los Angeles, CA</a></li>
                      <li class="footerli"><a class="footera graytext" href="#">Homes for Rent in Boston, Massachusetts</a></li>
                      <li class="footerli"><a class="footera graytext" href="#">Homes for Sale in Canadice, Ontario</a></li>
                      <li class="footerli"><a class="footera graytext" href="#">Homes for Sale in Universal City, CA</a></li>
