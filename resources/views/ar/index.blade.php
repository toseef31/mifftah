  ...
  <div class="mainindexcontainer">
    ...
    <div class="indexright rightmenu pull-right">
      <ul class="indexul left">
        ...
        <a href="{{ url('/home') }}" class="indexli left  language" style=" margin-right: 12px;
    padding: 7px 0px;
    ...
    margin-top: -5px;">En</a>
        ...
        <?php }else{ ?>
        <li class="indexli" style="display: inline-block;"><a class="robotomedium" href="{{ url('/ar-user/dashboard') }}" style="color: white;text-transform: uppercase;"><?= Auth::user()->name; ?></a></li>
      </ul>
      <?php } ?>
      </ul>
      <div class="menuouter left">
        <div class="mainmenuclick">
          ...
          <span class="menunaem left whitetext robotoregular font-size14">Menu</span></div>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="middle">
    <div class="inner">
      <div class="mainindexcontainer">
        ...
        <h1 class=" robotolight scontentheading">بحث عن المنازل ل <span class="robotomedium changecontent" >يشترى</span></h1>
        <p class="robotolight scontentp" id="temptextchange">المصدر الأكثر اكتمالا من المنازل للشراء</p>
        <div class="searchloactionwrp fulwidthm left">
          <div class="searchloactionwrpin  fulwidthm left">
            <div class="searchloctionbtnwrp">
              <div class="btnsef">
                <button class="indexlocbtn lblue_bg btn_rent robotoregular active" id="buyx">يشترى</button>
              </div>
              <div class="btnsef">
                <button class="indexlocbtn dblue_bg btn_sell robotoregular " id="rentx">إيجار</button>
              </div>
            </div>
          </div>
        </div>
        <div class="seinwrp fulwidthm left">
          <div class="seinwrp_in">
            ...
            <form class="" role="form" method="post" action="{{ url('/search') }}">
              {{  csrf_field() }}
              <input class="maininexinput" type="text" name="citysearch" id="citysearch2" placeholder="البحث عن طريق مدينة أو منطقة" value="">
              <button class="maininputbtn lblue_bg" id="searchnx"><i class="flaticon-magnifying-glass34"></i></button>
            </form>
          </div>
          <div id="errordisp" style="visibility:hidden;"><b><i class="fa fa-arrow-circle-up"></i> يرجى تعيين الموقع</b></div>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="lobox whitebg fulwidthm left pdg30 ">
          ...
          <div class="wishlistpopright col-sm-9 nopaddingR">
            ...
            <div class="wiscatwrper fulwidthm">
              <div class="wishlistlitingwrp"> الرجاء تحديد قوائم الرغبات التي تريد إضافة هذه القائمة. !
              ...
              <div class="createwishlist">
                <h3 class=" robotomedium graytext  mgnTB15 font-size14 createnew_wclick">Create New category &nbsp;<i class="flaticon-arrow486"></i></h3>
                <div class="cratewinput fulwidthm graybg pdg05 left mgnB10">
                  ...
                  <div class="col-md-3 nopadding" style="padding-left:14px !important;">
                    <button class="btn lblue_bg" onclick="createwishlist()">Create</button>
                  </div>
                </div>
                ...
                <div class="clearfix"></div>
                <button class="btn lblue_bg" onclick="mapwishlist()">Save</button>
...
<div class="indexcwrper fulwidthm left mgnB20 ">
        ...
        <div class="indexbox_in pdg20 fulwidthm left">
          <div class="newlsitingwrp">
            <div class="col-xs-12 col-sm-3">
              ...
              <p class="newlsitingp fontsize18 robotolight">Popular Listings in
        ...
        <div class="indexbox_in pdg20 fulwidthm left">
          <div class="listingstuts fulwidthm left">
            <div class="listingstutstilte text-center">
              <h4 class="robotolight fontsize24">حاليا في <span class="robotomedium">للبيع شبكة</span></h4>
              <!--
  <p class="listsub robotolight fontsize16">In the last 24 Hours</p>
              ...
              <div class="ststusbox text-center col-lg-3 col-sm-6 col-xs-12 mgnB10">
                <div class="ststusbox_in">
                  ...
                  <div class="status_dindex graybg robotolight">
                    ...
                    <p class="stsusname fontsize18 robotolight">جميع القوائم النشطة</p>
                  </div>
                </div>
              </div>
              <div class="ststusbox text-center col-lg-3 col-sm-6 col-xs-12 mgnB10">
                <div class="ststusbox_in">
                  ...
                  <div class="status_dindex graybg">
                    ...
                    <p class="stsusname fontsize18 robotolight">منازل مفتوحة</p>
                  </div>
                </div>
              </div>
              <div class="ststusbox text-center col-lg-3 col-sm-6 col-xs-12 mgnB10">
                <div class="ststusbox_in">
                  ...
                  <div class="status_dindex graybg">
                    ...
                    <p class="stsusname fontsize18 robotolight">القوائم تباع</p>
                  </div>
                </div>
              </div>
              <div class="ststusbox text-center col-lg-3 col-sm-6 col-xs-12 mgnB10">
                <div class="ststusbox_in">
                  ...
                  <div class="status_dindex graybg">
                    ...
                    <p class="stsusname fontsize18 robotolight">السعر خفض</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section class="indexbox  mgnTB15 whitebg fulwidthm left">
        <div class="indexbox_in pdg20 fulwidthm left">
          <div class="listingstutstilte text-center">
            <h4 class="robotolight fontsize24">أعلى المدن في <span class=" robotomedium">الولايات المتحدة</span></h4>
            <p class="listsub robotolight fontsize16">البحث عن أماكن لشراء / ايجار في هذه المدن</p>
          </div>
          <div class="populrcitwrp fulwidthm mgnT30 left">
            <div class="row">
                ...
                <div class="indexbox_in pdg20 fulwidthm left">
                  <div class="indexcaluclatorwrp">
                    <div class="ca_tb_btnwrp">
                      <div class="cal_tab_btn active"> الصفحة الرئيسية القدرة على تحمل التكاليف حاسبة</div>
                      <div class="cal_tab_btn"> آلة حساب الرهن العقاري</div>
                      <div class="cal_tab_btn"> إيجار مقابل شراء آلة حاسبة</div>
                    </div>
                    <div class="cal_tabwrp fulwidthm left">
                      <div class="cal_tabbox active">
                        <div class="cal_tabbox_in pdgTB30">
                          <p class="tabsp lgraytext font-size14">استخدام هذه الآلة الحاسبة لتحديد الحد سعر منزل كنت لا تستطيع تحمله. قبل الدخول في التفاصيل حول الدفع الخاصة بك شهرية معقولة، دفعة، ومدة القرض. يمكنك تقدير الحد الأقصى للميزانية تستطيع من خلال هذه الحسابات.</p>
                          <div class="clearfix"></div>
                          <div class="row mgnT60">
                            <div class="calculatorleft col-sm-4 col-xs-12">
                              <div class="calrow fulwidthm left mgnB20">
                                <label class="callabel robotoregular fontsize18 mgnB10 graytext">الدفع الشهري (₪)</label>
                              ...
                              <div class="calrow fulwidthm left mgnB20">
                                <label class="callabel robotoregular fontsize18 mgnB10 graytext"> الدفعة الأولى (₪)</label>
                              ...
                              <div class="calrow fulwidthm left mgnB20">
                                <label class="callabel robotoregular fontsize18 mgnB10 graytext"> معدل الفائدة (%)</label>
                              ...
                              <div class="calrow fulwidthm left mgnB20">
                                <label class="callabel robotoregular fontsize18 mgnB10 graytext">عدد سنوات</label>
                              ...
                              <div class="calrow fulwidthm left mgnB20">
                                <button id="homeaffordcalbut" class="whitetext lblue_bg fontsize16 border-radius3 pdg10 clacluatebtn fulwidthm left">حساب</button>
                              </div>
                            </div>
                            <div class="calcuright col-sm-7 col-xs-12 pull-right">
                              ...
                              <div class="calcuright_in graybg pdg20">
                                <div class="clacamountwrp text-center">
                                  <p class="fontsize18 graytext robotoregular">يمكنك شراء منزل حتى </p>
                                  <h2 class="amountcal fontsize30 robotoregular" id="amthomeafford">₪ 439,936</h2>
                                  <p class="robotoregular fontsize13 mgnTB20">على أساس الدخل الخاص بك، يجب منزل في هذا السعر تتلاءم بشكل مريح في حدود ميزانيتك.</p>
                                  <div class=" clearfix"></div>
                      ...
                      <div class="cal_tabbox ">
                        <div class="cal_tabbox_in pdgTB30">
                          <p class="tabsp lgraytext font-size14">استخدام هذه الآلة الحاسبة لتقدير الشهري دفع الرهن العقاري، باستثناء الضرائب والتأمين. ما عليك سوى إدخال سعر المنزل، دفعة أولى بك، وتفاصيل حول مدة القرض لحساب الدفع الشهري.</p>
                          <div class="clearfix"></div>
                          <div class="row mgnT60">
                            <div class="calculatorleft col-sm-4 col-xs-12">
                              <div class="calrow fulwidthm left mgnB20">
                                <label class="callabel robotoregular fontsize18 mgnB10 graytext"> المبلغ الرهن العقاري (₪)</label>
                              ...
                              <div class="calrow fulwidthm left mgnB20">
                                <button id="mortgagecalbut" class="whitetext lblue_bg fontsize16 border-radius3 pdg10 clacluatebtn fulwidthm left">حساب</button>
                              </div>
                            </div>
                            <div class="calcuright col-sm-7 col-xs-12 pull-right">
                              <div class="clacicon dblue_bg whitetext"><i class="flaticon-home153"></i></div>
                              <div class="calcuright_in graybg pdg20">
                                <div class="clacamountwrp text-center">
                                  <p class="fontsize18 graytext robotoregular"> الخاص بنظام الدفع الشهري</p>
                                  <h2 class="amountcal fontsize30 robotoregular" id="amtmotgagemonth">₪ 2,381</h2>
                                  <p class="robotoregular fontsize13 mgnTB20">واستنادا إلى كمية الرهن العقاري الخاص بك، يجب أن تدفع هذا المبلغ شهريا لمدة القرض</p>
                                  <div class=" clearfix"></div>
                                  <div class="indexcalpricerange">
                                    <div class="indexcalpricerangeimgs fulwidthm left mgnB10">
                                      <div class="pricerangeleft pricon left"><i class="flaticon-tag77"></i></div>
                      ...
                      <div class="cal_tabbox ">
                        <div class="cal_tabbox_in pdgTB30">
                          <p class="tabsp lgraytext font-size14">استخدام هذه الآلة الحاسبة للمساعدة في جعل نائب قرار حول تأجير أو شراء هو أفضل. إذا كنت تبحث عن إقامة طويلة الأجل، فإن معظم حالات الشراء يكون أفضل.</p>
                          <div class="clearfix"></div>
                          <div class="row mgnT60">
                            <div class="calculatorleft col-sm-4 col-xs-12">
                              <div class="calrow fulwidthm left mgnB20">
                                <label class="callabel robotoregular fontsize18 mgnB10 graytext"> المطلوب الأسعار الرئيسية (₪)</label>
                                <input id="desiredhomeprice" class="gcinput fulwidthm left" type="text" value="800000">
                                <div class=" rederror fulwidthm left" id="e1"></div>
                              </div>
                              <div class="calrow fulwidthm left mgnB20">
                                <label class="callabel robotoregular fontsize18 mgnB10 graytext"> المطلوب ايجار شهري (₪)</label>
                                <input id="desiredrent" class="gcinput fulwidthm left" type="text" value="8000">
                                <div class=" rederror fulwidthm left" id="e2"></div>
                              </div>
                              <div class="calrow fulwidthm left mgnB20">
                                <button id="rentbuycalbut" class="whitetext lblue_bg fontsize16 border-radius3 pdg10 clacluatebtn fulwidthm left">حساب</button>
                              </div>
                            </div>
                            <div class="calcuright col-sm-7 col-xs-12 pull-right">
                              <div class="clacicon dblue_bg whitetext"><i class="flaticon-home153"></i></div>
                              <div class="calcuright_in graybg pdg20">
                                <div class="clacamountwrp text-center">
                                  <p class="fontsize18 graytext robotoregular" id="nomonthsbuy"> وشراء يكون أفضل من الإيجار بعد 8 سنوات و 4 شهور</p>
                                  <div class=" clearfix"></div>
                                </div>
                              </div>
                            </div>
              ...
              <section class="indexbox  mgnTB15 whitebg fulwidthm left">
                <div class="indexbox_in pdg20 fulwidthm left">
                  <div class="listingstutstilte text-center">
                    <h4 class="robotolight fontsize24">لماذا <span class=" robotomedium">للبيع شبكة؟</span></h4>
                    <p class="listsub robotolight fontsize16">على لكل شيء بيع الشبكة تحتاج إلى العثور يتم تقديم وجبة المنزل جيدا.</p>
                  </div>
                  <div class="row">
                    <div class="whyuswrp fulwidthm left mgnT30">
                      <div class="whyusbox col-sm-4 col-xs-12 mgnB10">
                        <div class="whyusboxin listforubox">
                          <h4 class="robotomedium graytext fontsize18">منازل لك</h4>
                          <p class="robotoregular font-size14 lgraytext">يمكنك العثور على مجموعة متنوعة واسعة من المنازل في للبيع الشبكة </p> <a href="#" class=" robotomedium lbluetext">تعرف أكثر >> </a></div>
                      </div>
                      <div class="whyusbox col-sm-4 col-xs-12 mgnB10">
                        <div class="whyusboxin hwselbox">
                          <h4 class="robotomedium graytext fontsize18">ترغب في بيع</h4>
                          <p class="robotoregular font-size14 lgraytext">للبيع شبكة يساعدك على بيع منزلك في وقت قياسي </p> <a href="#" class=" robotomedium lbluetext">تعرف أكثر >> </a></div>
                      </div>
                      <div class="whyusbox col-sm-4 col-xs-12 mgnB10">
                        <div class="whyusboxin hwwrk">
                          <h4 class="robotomedium graytext fontsize18">كيف يعمل</h4>
                          <p class="robotoregular font-size14 lgraytext">معرفة كيفية شراء / بيع / استئجار منزل للبيع على شبكة </p> <a href="#" class=" robotomedium lbluetext">تعرف أكثر >> </a></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="mainontainer_in pdgS10">
                <div class="footerbox pdgTB50 fulwidthm left">
                  <div class="footerboxeach col-lg-3 col-md-3 col-sm-4 col-xs-4">
                    <h5 class="footerhead fontsize18 robotomedium ">مدن شعبية</h5>
                    <div class="clearfix"></div>
                    <ul class="footerul robotomedium">
                      <li class="footerli"><a class="footera graytext" href="#">نيويورك</a></li>
                      <li class="footerli"><a class="footera graytext" href="#">لاس فيغاس</a></li>
                      <li class="footerli"><a class="footera graytext" href="#">لوس أنجلوس</a></li>
                      <li class="footerli"><a class="footera graytext" href="#">سان فرانسيسكو</a></li>
                      <li class="footerli"><a class="footera graytext" href="#">شيكاغو</a></li>
                    </ul>
                  </div>
                  <!-- Footerboxeachends-->
                  <div class="footerboxeach col-lg-4 col-md-4 col-sm-4 col-xs-4">
                    <h5 class="footerhead fontsize18 robotomedium ">عمليات البحث الأخيرة</h5>
                    <div class="clearfix"></div>
                    <ul class="footerul robotomedium" >
                      <li class="footerli" dir="rtl" ><a class="footera graytext" href="#">بيوت للبيع في لوس انجليس</a></li>
                      <li class="footerli" dir="rtl"><a class="footera graytext" href="#">منازل للايجار في بوسطن، ماساتشوستس</a></li>
                      <li class="footerli" dir="rtl"><a class="footera graytext" href="#">بيوت للبيع في كاناديك، أونتاريو</a></li>
                      <li class="footerli" dir="rtl"><a class="footera graytext" href="#">بيوت للبيع في مدينة العالمي</a></li>
                      <li class="footerli" dir="rtl"><a class="footera graytext" href="#">جميع المنازل أورلاندو، فلوريدا</a></li>
                    
                    </ul>
                  </div>
                  <!-- Footerboxeachends-->
                  <div class="footerboxeach col-lg-2 col-md-2 col-sm-4 col-xs-4">
                    <h5 class="footerhead fontsize18 robotomedium ">شركة</h5>
                    <div class="clearfix"></div>
                    <ul class="footerul robotomedium">
                      <li class="footerli"><a class="footera graytext" href="#">معلومات عنا</a></li>
                      <li class="footerli"><a class="footera graytext" href="#">الشروط والسياسات</a></li>
                      <li class="footerli"><a class="footera graytext" href="#">اتصل بنا</a></li>
                      <li class="footerli"><a class="footera graytext" href="#">مكتب الدعم</a></li>
                  ...
                  <div class="footerboxeach col-lg-3 col-md-3 col-sm-12 col-xs-12 mgnT30">
                    ...
                    <div class="copyrightwrp text-center left fulwidthm fontsize12 lgraytxt"> حق النشر &copy; 2016 للبيع الشبكة. كل الحقوق محفوظة.</div>
