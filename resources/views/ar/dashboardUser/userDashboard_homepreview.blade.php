              ...
              <div class="detlcontent  fulwidthm left  " style="display: block;">
                <ul class="detillistingul ">
                  <li class="detaillistingli left mgnB20">
                    <span class="detaillititle col-sm-6 col-xs-6 nopaddingL lgraytext"><i class="flaticon-beds5"></i> سرير</span> <span class="detaillititledis col-sm-6 col-xs-6 nopaddingR robotomedium">{{$data->beds }} سرير</span>
                  
                  </li>
                  <li class="detaillistingli left mgnB20">
                    <span class="detaillititle col-sm-6 col-xs-6 nopaddingL lgraytext"><i class="flaticon-squares37 "></i> بيت الحجم</span> <span class="detaillititledis col-sm-6 col-xs-6 nopaddingR robotomedium">{{$data->homesize }} قدم مربع </span>
                  
                  </li>
                  <li class="detaillistingli left mgnB20">
                    <span class="detaillititle col-sm-6 col-xs-6 nopaddingL lgraytext"><i class="flaticon-payment7"></i> السعر</span> <span class="detaillititledis col-sm-6 col-xs-6 nopaddingR robotomedium">$ {{$data->price }}</span>
                  
                  </li>
                  
                  
                  <li class="detaillistingli left mgnB20">
                    <span class="detaillititle col-sm-6 col-xs-6 nopaddingL lgraytext"><i class="flaticon-flag32"></i> الحالة</span> <span class="detaillititledis col-sm-6 col-xs-6 nopaddingR robotomedium">نشط</span>
                  
                  </li>
                  <li class="detaillistingli left mgnB20">
                    <span class="detaillititle col-sm-6 col-xs-6 nopaddingL lgraytext"><i class="flaticon-shower15"></i> الحمامات </span> <span class="detaillititledis col-sm-6 col-xs-6 nopaddingR robotomedium">{{$data->bathrooms }} الحمامات</span>
                  
                  </li>
                  <li class="detaillistingli left mgnB20">
                    <span class="detaillititle col-sm-6 col-xs-6 nopaddingL lgraytext"><i class="flaticon-squares37"></i> حجم كبير</span> <span class="detaillititledis col-sm-6 col-xs-6 nopaddingR robotomedium">{{$data->homesize }} قدم مربع  </span>
                  
                  </li>
                  
                  <li class="detaillistingli left mgnB20">
                    <span class="detaillititle col-sm-6 col-xs-6 nopaddingL lgraytext"><i class="flaticon-calendar146"></i> بنيت عام</span> <span class="detaillititledis col-sm-6 col-xs-6 nopaddingR robotomedium">{{$data->yearbuilt }}</span>
                  </li>
                </ul>
  ...
  <div class="detailsfullright  col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
    ...
    <div class="reqstinfowrp fulwidthm left mgnB15">
      ...
      <form class="" role="form" method="post" action="{{ url('form/submit/booking/') }}">
        ...
        {{ csrf_field() }}
        <div class="rqstinfotitle dblue_bg pdg15 fulwidthm fontsize16 left whitetext">قل لي المزيد عن هذا العقار</div>
        <div class="reqstinfowrp_in fulwidthm left  whitebg">
                ...
                <li class="brokerRli fulwidthm left mgnB15">
                  ...
                  <div class="brokerright">
                    ...
                    <div class="brkerRbottom fontsize12">
                      <span class="brkRsalec lgraytext">1 مبيعات الأخيرة</span> &nbsp;|&nbsp; <span class="brkRstsc lbluetext">وكيل قسط</span></div>
                  </div>
                </li>
              </ul>
            </div>
          ...
          <div class="rqstinfoformswrp">
            <div class="pdg15 fulwidthm left rqstinfoformswrp_in">
              ...
              <div class="rqstfrmrow fulwidthm left mgnB15">
                <input class="rqstfrminput fulwidthm left" id="reqname" name="name" type="text" placeholder="Your Name" value="<?= (Auth::check())?Auth::user()->name:''; ?> ">
              </div>
              <div class="rqstfrmrow fulwidthm left mgnB15">
                <input class="rqstfrminput fulwidthm left" id="reqemail" name="email" type="email" placeholder="Your Email" value="<?= (Auth::check())?Auth::user()->email:''; ?> ">
              </div>
              <div class="rqstfrmrow fulwidthm left mgnB15">
                <input class="rqstfrminput fulwidthm left" id="reqphno" name="phone" type="text" placeholder="Contact Number" value="<?= (Auth::check())?Auth::user()->phone:''; ?>">
              </div>
              <div class="rqstfrmrow fulwidthm left mgnB15">
                <textarea class="rqstfrminput fulwidthm left" name="message" id="reqmess" placeholder="Your Message"></textarea>
              </div>
              <div title="Book NOw" style="padding-bottom: 12px;">
                <select class="form-control" name="bookingStatus" required>
                  <option selected="selected">حدد مركز الحجز</option>
                  <option value="1">كتاب الان</option>
                  <option value="0">احجز في وقت لاحق</option>
                </select>
              </div>
              ...
              <div class="rqstfrmrow fulwidthm left mgnB15">
                <button class="lblue_bg fulwidthm left pdgTB10 fontsize18 reqstinfopoopen" id="requestbut">طلب معلومات</button>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="detilwishlistbtn transition2 mgnB15 whitetext  text-center fulwidthm left whishorngnebtn" id="wishlistttt_3" title="Save to Wishlist">
      ...
      <h3 class="whsilisttile  robotoregular fontsize16">حفظ الى قائمة الامنيات</h3>
    </div>
